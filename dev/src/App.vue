...
<template>
  <div
    class="grid grid-cols-3 shadow-2xl w-full max-w-5xl mx-auto my-10 h-screen max-h-[calc(100vh-5rem)]
    rounded-3xl overflow-hidden"
  >
    <!-- {/* Left Panel - Glass Effect Demo */} -->
    <div ref="containerRef" class=" flex-1 relative overflow-auto col-span-2">
      <div class="w-full min-h-[200vh] absolute top-0 left-0 pb-96 mb-96">
        ...
        <p class="px-10">
          Bacon ipsum dolor amet hamburger Bacon ipsum dolor amet hamburger Bacon ipsum dolor amet
          hamburger Bacon ipsum dolor amet hamburger
        </p>
      ...
      <LiquidGlass
        ...
        :corner-radius="cornerRadius" :mouse-container="containerRef" :over-light="userInfoOverLight" :style="{
          position: 'fixed',
          top: '25%',
          left: '40%',
        }"
      ...
      <LiquidGlass
        ...
        :over-light="logoutOverLight" padding="8px 16px" :style="{ position: 'fixed', top: '20%', left: '40%' }"
      >
    ...
    >
      <div class="mb-8">
        ...
        <p class="text-white/60 text-sm">
          Liquid Glass container effect for React. With settings and effects and
          stuff.
        </p>
      </div>
      ...
      <div class="space-y-8 flex-1">
        <template v-if="activeTab === 'userInfo'">
          ...
          <div>
            ...
            <div class="flex items-center space-x-3">
              <input
                id="userInfoOverLight" v-model="userInfoOverLight" type="checkbox"
        ...
        <template v-if="activeTab === 'logOut'">
          ...
          <div>
            ...
            <div class="flex items-center space-x-3">
              <input
                id="logoutOverLight" v-model="logoutOverLight" type="checkbox"
                class="w-5 h-5 accent-blue-500"
              >
